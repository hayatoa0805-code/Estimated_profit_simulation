...
ad_cost = st.sidebar.slider('広告費', 1000, 9000) * 1.0E+04
...
data_profit = [
    calc_profit(earnings, ad_cost*1.0E+04 + fix_cost) for earnings, ad_cost in zip(data_earnings, data_ad_cost)]
